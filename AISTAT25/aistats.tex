...
In this section we provide experimental evidence that our algorithm has low query complexity.
...
smooth function of $x$. We used a sample of 10,000 points and ran our
algorithm 20 times. In figure~\ref{fig:experiments} we present the
...
Number of queries as a function of the accuracy for passive and active algorithms.
